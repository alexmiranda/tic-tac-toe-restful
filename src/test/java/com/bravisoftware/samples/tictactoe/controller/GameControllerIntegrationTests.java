...
public class GameControllerIntegrationTests {
	...
	@Test
	void create_new_game() throws Exception {
	...
	@Test
	void getting_a_brand_new_game_returns_ok() throws Exception {
	...
	@Test
	void new_game_returns_correct_status_in_response_body() throws Exception {
		mockMvc.perform(get("/api/games/{0}", EXISTING_GAME_ID))
				.andExpect(jsonPath("$.status", is("Open")));
	}

	@Test
	void new_game_constains_link_to_itself() throws Exception {
	...
	@Test
	void new_game_constains_link_to_play() throws Exception {
	...
	@Test
	void new_game_does_not_constain_link_to_undo() throws Exception {
		mockMvc.perform(get("/api/games/{0}", EXISTING_GAME_ID))
				.andExpect(jsonPath("$.links..[?(@.rel == 'undo')]").doesNotExist());
	}

	@Test
	void game_in_progress_has_last_move_specified_in_body() throws Exception {
	...
	@Test
	void game_in_progress_has_self_play_and_undo_links() throws Exception {
	...
	@Test
	void get_a_non_existing_game_returns_404_not_found() throws Exception {		
	...
	@Test
	void should_play_and_return_status_ok() throws Exception {
	...
	@Test
	void cannot_play_with_empty_json_string_and_returns_400_bad_request() throws Exception {		
	...
	@Test
	void cannot_play_without_passing_the_position_and_returns_400_bad_request() throws Exception {		
	...
	@Test
	void cannot_play_without_passing_the_mark_and_returns_400_bad_request() throws Exception {		
	...
	@Test
	void should_return_409_conflict_status_when_invalid_player() throws Exception {		
		game.play(Position.TopLeftCorner, Mark.X);
	...
	@Test
	void should_return_409_conflict_status_when_filled_position_is_played() throws Exception {
		game.play(Position.TopLeftCorner, Mark.X);
	...
	@Test
	void deleting_the_last_move_returns_200_if_the_game_is_in_progress() throws Exception {
		game.play(Position.BottonEdge, Mark.X);
	...
	@Test
	void cannot_undo_last_move_if_there_is_no_moves_and_returns_409_conflict() throws Exception {
		mockMvc.perform(delete("/api/games/{0}/lastMove", EXISTING_GAME_ID))
				.andExpect(status().isConflict());
	}

	@Test
	void when_game_is_over_with_a_draw_status_should_be_draw() throws Exception {
	...
	@Test
	void when_game_is_over_with_X_winning_status_should_be_x_wins() throws Exception {
	...
	@Test
	void when_game_is_over_with_nought_winning_status_should_be_x_wins() throws Exception {
	...
	@Test
	void when_game_is_over_it_should_not_contain_link_to_play() throws Exception {
		completeGameWithDraw(game);
		mockMvc.perform(get("/api/games/{0}", EXISTING_GAME_ID))
	...
	@Test
	void when_game_is_over_it_should_not_contain_link_to_undo() throws Exception {
		completeGameWithDraw(game);
		mockMvc.perform(get("/api/games/{0}", EXISTING_GAME_ID))
			.andExpect(jsonPath("$.links..[?(@.rel == 'undo')]").doesNotExist());
	}
